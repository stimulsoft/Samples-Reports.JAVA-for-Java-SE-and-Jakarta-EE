 ...
 */
public class UsingEventsOfTheReportRenderProcess extends JPanel {
    ...
    public UsingEventsOfTheReportRenderProcess(final JFrame parentFrame) throws IOException, SAXException, StiDeserializationException {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    frame.add(new UsingEventsOfTheReportRenderProcess(frame));
